        ...
        return (
            <section {...props}>
                ...
                <Flex className="matchRow" backgroundColor={color}>
                    ...
                    <View className="playerName"><Link to={"/players/" + match.winner.id}>{match.winner[0].name}</Link></View>
                    <View className="playerName"><Link to={"/players/" + match.loser.id}>{match.loser[0].name}</Link></View>
